...
IBSMSG.Ko = {
  "Lang": {
    ...
    "Accessibility": {
      ...
      "BeginNotice": "%1 시트의 상단입니다. 시트 사용 안내는 Control + H Key로 확인할 수 있습니다.",
      ...
      "Help": {
        "HeadText": "도움말 다이얼로그",
        "BeginBody": "시트 사용 안내 페이지 입니다. 카테고리에서 스페이스바를 누르시면 해당 기능의 설명들을 펼쳐 보실 수 있습니다.",
        "EndBody": "시트 사용 안내의 마지막 입니다.",
        "Title": "제목",
        "Close": "닫기",
        "Category": "%1 카테고리. 총 %2개 입니다.",
        "CategoryFold": "%1 카테고리를 접었습니다.",
        "CategoryUnfold": "%1 카테고리를 펼쳤습니다.",
        "ContentPos": "%1번째 리스트입니다.",
        "Keys": {
          "Name": "단축키",
          "Items": [
            {
              "Name": "Ctrl + 왼쪽/오른쪽 방향키",
              "Value": "헤더행에서 포커스된 열의 위치를 이동합니다.",
              "CombineKeys": [
                "Ctrl",
                "LeftArrow",
                "RightArrow"
            ...
            {
              "Name": "Ctrl + Shift + 왼쪽/오른쪽 방향키",
              "Value": "헤더행에서 포커스된 열의 너비를 5픽셀씩 조절합니다.",
              "CombineKeys": [
                "Ctrl",
                "Shift",
                "LeftArrow",
            ...
            },
            {
              ...
              "Value": "필터행에서 포커스된 셀의 필터 메뉴를 열수 있습니다.",
              "CombineKeys": [
                "Ctrl",
                "Enter"
              ]
            },
            {
              ...
              "Value": "트리를 사용하는 시트에서 행을 접고 펼칠 수 있습니다.",
              "CombineKeys": [
                "Ctrl",
                "Enter"
              ]
            },
            {
              ...
              "Value": "포커스된 셀에 아이콘이 있는 경우 기능을 동작시킵니다.",
              "CombineKeys": [
                "Ctrl",
                "Shift",
                "Enter",
            ...
            },
            {
              ...
              "Value": "포커스된 셀에 버튼이 있는 경우 기능을 동작시킵니다.",
              "CombineKeys": [
                "Ctrl",
                "Shift",
                "Alt",
        ...
        "Constraint": {
          ...
          "Items": [
            {
              "Name": "단축키 설정",
              "Value": "스크린 리더 사용시 아이비 시트와 기능키가 중복 될 수 있으므로 가상커서를 임시 해제하거나 스크린리더 단축키를 일시 중지해야 합니다.",
              "CombineKeys": [
                "KeyBoard",
                "VirtualCursors",
                "FeatureKeys"
    ...
    "Dialog": {
      ...
      "WrongTypeWarn": "데이터 값에는 숫자형이, 행/열 기준에는 그 외의 값이 들어가야합니다.",
